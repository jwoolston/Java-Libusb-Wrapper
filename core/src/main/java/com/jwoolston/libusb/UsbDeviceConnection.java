...
public class UsbDeviceConnection {
     ...
     */
    public UsbDeviceConnection(@NotNull UsbManager manager, @NotNull UsbDevice device) {
    ...
    public byte[] getRawDescriptors() {
        return nativeGetRawDescriptor(device.getNativeObject());
    }
    ...
    @Nullable
    private native byte[] nativeGetRawDescriptor(@NotNull ByteBuffer device);
