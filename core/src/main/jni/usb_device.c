...
Java_com_jwoolston_libusb_UsbDevice_nativeGetStringDescriptor(JNIEnv *env, jclass type, jobject device,
                                                                      jint index) {
    if (index == 0) {
        return NULL;
    }
...
Java_com_jwoolston_libusb_UsbDevice_wrapDevice(JNIEnv *env, jclass type, jobject context, jint fd) {
...
JNIEXPORT jstring JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetDeviceName(JNIEnv *env, jobject instance, jobject device) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
    uint8_t port_numbers[56]; // Per USB3, a maximum of 7 ports deep
    int count = libusb_get_port_numbers(deviceHandle->dev, port_numbers, 7);
    size_t length = 28 * sizeof(unsigned char);
    unsigned char *name = malloc(length);
    int index = 0;
    for (int i = 0; i < count; ++i) {
        index += snprintf(name, 4, "/%d", port_numbers[i]);
    }
...
JNIEXPORT jstring JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetManufacturerString(JNIEnv *env, jobject instance, jobject device,
                                                                        jobject descriptor) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
...
JNIEXPORT jstring JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetProductNameString(JNIEnv *env, jobject instance, jobject device,
                                                                       jobject descriptor) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
    struct libusb_device_descriptor *deviceDescriptor = (struct libusb_device_descriptor *)
...
JNIEXPORT jstring JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetSerialNumberString(JNIEnv *env, jobject instance, jobject device,
                                                                        jobject descriptor) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
    struct libusb_device_descriptor *deviceDescriptor = (struct libusb_device_descriptor *)
    ...
    size_t length = 120 * sizeof(unsigned char);
    unsigned char *name = malloc(length);
    libusb_get_string_descriptor_ascii(deviceHandle, deviceDescriptor->iSerialNumber, name, (int) length);
    jstring retval = (*env)->NewStringUTF(env, (const char *) name);
    free(name);
    return retval;
}
...
JNIEXPORT jstring JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetDeviceVersion(JNIEnv *env, jobject instance, jobject descriptor) {
    struct libusb_device_descriptor *deviceDescriptor = (struct libusb_device_descriptor *)
            (*env)->GetDirectBufferAddress(env, descriptor);
...
Java_com_jwoolston_libusb_UsbDevice_nativeGetDeviceSpeed(JNIEnv *env, jobject instance, jobject device,
                                                                 jobject descriptor) {
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetConfigurationCount(JNIEnv *env, jobject instance, jobject device) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
...
Java_com_jwoolston_libusb_UsbDevice_nativeGetPointerFromNativeObject(JNIEnv *env, jobject instance,
                                                                             jobject device) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
...
JNIEXPORT jobject JNICALL
Java_com_jwoolston_libusb_UsbDevice_nativeGetNativeObjectFromPointer(JNIEnv *env, jobject instance,
                                                                             jlong pointer) {
