...
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeInitialize(JNIEnv *env, jclass type) {
...
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeClose(JNIEnv *env, jobject instance, jobject device) {
...
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeGetRawDescriptor(JNIEnv *env, jobject instance, jint fd) {
    char buffer[16384];
    if (fd < 0) return NULL;
    lseek(fd, 0, SEEK_SET);
...
JNIEXPORT jbyteArray JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeGetRawDescriptor(JNIEnv *env, jobject instance, jobject device) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
    const size_t configStep = sizeof(struct libusb_config_descriptor) - sizeof(int);
    size_t descriptorSize = sizeof(struct libusb_device_descriptor);
    struct libusb_device_descriptor device_descriptor = deviceHandle->dev->device_descriptor;
    int configCount = device_descriptor.bNumConfigurations;
    descriptorSize += configCount * configStep;
    uint8_t *raw = malloc(descriptorSize);
    memcpy(raw, &device_descriptor, sizeof(struct libusb_device_descriptor));
    int index = sizeof(struct libusb_device_descriptor);
    for (int i = 0; i < device_descriptor.bNumConfigurations; ++i) {
        struct libusb_config_descriptor *config_descriptor;
        libusb_get_config_descriptor(deviceHandle->dev, i, &config_descriptor);
        memcpy(raw + index, &config_descriptor, configStep);
        index += configStep;
    }
    jbyteArray ret = (*env)->NewByteArray(env, index);
    if (ret) {
        jbyte *bytes = (jbyte *) (*env)->GetPrimitiveArrayCritical(env, ret, 0);
        if (bytes) {
            memcpy(bytes, raw, index);
            (*env)->ReleasePrimitiveArrayCritical(env, ret, bytes, 0);
        }
    }
    free(raw);
...
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeClearStall(JNIEnv *env, jobject instance, jobject device,
                                                                       jint address) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeClaimInterface(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeReleaseInterface(JNIEnv *env, jobject instance,
                                                                             jobject device, jint interfaceID) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeSetInterface(JNIEnv *env, jobject instance, jobject device,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeSetConfiguration(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeControlRequest(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeControlRequestAsync(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeBulkRequest(JNIEnv *env, jobject instance, jobject device,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeBulkRequestAsync(JNIEnv *env, jobject instance,
                                                                             jobject device, jobject callback,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeInterruptRequest(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeInterruptRequestAsync(JNIEnv *env, jobject instance,
                                                                                  jobject callback,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeIsochronousRequestAsync(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_jwoolston_libusb_UsbDeviceConnection_nativeResetDevice(JNIEnv *env, jobject instance, jobject device) {
    struct libusb_device_handle *deviceHandle = (struct libusb_device_handle *) (*env)->GetDirectBufferAddress(env,
                                                                                                               device);
